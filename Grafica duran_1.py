...
ax.text(-0.3, 0.8, 'PIPE DIAMETER: D [m]', rotation=0)
ax.text(-0.55, -3, 'SOLIDS SPECIFIC GRAVITY: S [-]', rotation=90)
ax.text(-0.1, -3, 'LIMITING SETTLING VELOCITY: VL = FL√(gD(S-1)) [m/s]', rotation=90)
